 ...
 * @returns {Int32Array}
 */
export function find_path_on_grid_wasm(start_x, start_y, goal_x, goal_y, costs_flat, zone_types_flat, teleporters_flat) {
    ...
    const ret = wasm.find_path_on_grid_wasm(start_x, start_y, goal_x, goal_y, ptr0, len0, ptr1, len1, ptr2, len2);
